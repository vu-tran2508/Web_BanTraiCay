...
const ListAllOrder = () => {
    ...
    const [loading, setLoading] = useState(true); // Khởi tạo state loading với giá trị là true
...
useEffect(() => {
    const fetchData = async () => {
        try {
            ...
            setLoading(false); // Xử lý lỗi, set loading thành false
        }
    };
    ...
    return (
        <div>
            {loading ? ( // Nếu loading là true, hiển thị biểu tượng loading
